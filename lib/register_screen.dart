...
class _RegisterScreenState extends State<RegisterScreen> {
          ...
          child: Column(
            ...
            children: [
              ...
              TextField(
                ...
                decoration: _buildInputDecoration(label: 'Apellido'),
              ),
              const SizedBox(height: 15),
              TextField(
                controller: _emailController,
                keyboardType: TextInputType.emailAddress,
                decoration: _buildInputDecoration(label: 'Correo Electrónico'),
              ),
              const SizedBox(height: 15),
              ...
              TextField(
                ...
                obscureText: true,
                decoration: _buildInputDecoration(label: 'Contraseña'),
              ),
              const SizedBox(height: 15),
              TextField(
  ...
  // ✅ FUNCIÓN DE AYUDA MODIFICADA PARA ACEPTAR UN ICONO
